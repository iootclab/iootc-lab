package com.iootc.lab.gererator;
 ...
 * 一般是我们的 id 生成器开始使用的时间，由我们程序来指定的（如下下面程序 SnowflakeIdWorker 类的 startTime 属性）。41 位的时间截，可以使用 69 年（即 T = (1L << 41) / (1000L * 60 * 60 * 24 * 365) = 69）<br>
 ...
 * SnowFlake 算法的优点是：整体上按照时间自增排序，并且整个分布式系统内不会产生 ID 碰撞(由数据中心 ID 和机器 ID 作区分)，并且效率较高，经测试，SnowFlake 算法每秒能够产生 26 万 ID 左右。
 */
/**
...
public class SnowflakeIdWorker {
    ...
    private final long start = 1573441871L;
